<?php
    ...
    if(isset($idUserSet)){*/
        ...
        $search_image = mysqli_query($link, "SELECT idUser, usrName, usrLastName, usrEmail, usrDateN, usrCellPhone, usrProfilePhoto FROM users WHERE usrEmail = '$keyUserSet'");
        ...
        $responseUserData["usrProfilePhoto"] = $array_result[0][6];
